...
$BABYLOND tx epoching delegate bbn1yhjmk395pku6h55cgvm7u2d6ffejv4qjz6ff3n 1000000ubbn --from wallet --chain-id bbn-test-2 --gas-adjustment 1.4 --gas auto --fees 10ubbn -y >> "$LOG_FILE" 2>&1
